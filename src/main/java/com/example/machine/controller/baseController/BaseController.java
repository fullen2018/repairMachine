...
public class BaseController<M> {
    ...
    public static  String toDatabaseField(String name){
           ...
           for (int i = 0; i < indexs.size(); i++){
               name = name.substring(0,indexs.get(i)+i)+"_"+name.substring(indexs.get(i)+i,name.length());
           }
